<<<<<<<< HEAD:docs/attested-builds/how-it-works.md
# How Attested Builds Work
========
---
title: "How Attestable Builds Work"
description: "The architecture and mechanics of attestable builds, phase by phase, from source to running code."
---
>>>>>>>> 4176109 (feat(docs): integrated c8s docs from separate site):website/content/docs/attestable-builds/how-it-works.mdx
...
========
We assume you've read [What Are Attestable Builds?](/docs/attestable-builds/what-are-attestable-builds) and understand the core concept: attestable builds prove that specific inputs were used to produce specific outputs in a verified environment. This document shows exactly how that works.
>>>>>>>> 4176109 (feat(docs): integrated c8s docs from separate site):website/content/docs/attestable-builds/how-it-works.mdx

...
description: "What attestable builds protect against and what they don't — trust boundaries and residual assumptions."
---

<<<<<<<< HEAD:docs/attested-builds/threat-model.md
...
========
This document explains what attestable builds protect against and what they don't. After reading it, you'll understand where the trust boundaries lie, what specific attacks are prevented, and which assumptions you're still making. We assume familiarity with the concepts from the previous sections: [What Are Attestable Builds?](/docs/attestable-builds/what-are-attestable-builds), [How It Works](/docs/attestable-builds/how-it-works), and [Provenance & Standards](/docs/attestable-builds/provenance-standards).
>>>>>>>> 4176109 (feat(docs): integrated c8s docs from separate site):website/content/docs/attestable-builds/threat-model.mdx

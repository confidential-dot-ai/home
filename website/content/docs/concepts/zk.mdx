...
description: "How Confidential uses zero-knowledge proofs to complement TEE attestation and prove the infrastructure operates correctly while preserving privacy."
---

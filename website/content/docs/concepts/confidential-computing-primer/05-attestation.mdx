...
description: "How attestation works under the hood: proving what code runs, on what hardware, with what configuration."
---
...
- [Document 4: Privilege & Communication](/docs/concepts/confidential-computing-primer/04-privilege-and-communication) for VMPLs and SVSM details
- [Document 6: Measurement Strategies](/docs/concepts/confidential-computing-primer/06-measurement-strategies) for extending trust beyond launch

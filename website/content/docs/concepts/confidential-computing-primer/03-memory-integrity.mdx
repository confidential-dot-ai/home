...
description: "How SEV-SNP protects guest memory integrity via the Reverse Map Table and page validation."
---
...
This assumes you've read [02-hardware-foundations.md](/docs/concepts/confidential-computing-primer/02-hardware-foundations) and understand how memory encryption works.

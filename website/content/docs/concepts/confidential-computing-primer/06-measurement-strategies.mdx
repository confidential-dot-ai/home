...
description: "The measurement problem — bridging the gap between what hardware measures at launch and what actually runs."
---
...
- [Document 5: Attestation & Verification](/docs/concepts/confidential-computing-primer/05-attestation) for how measurements end up in reports

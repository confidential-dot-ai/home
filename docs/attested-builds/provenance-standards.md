...
We assume familiarity with the attested builds concept from [What Are Attested Builds?](what-are-attested-builds.md) and the build flow from [How It Works](how-it-works.md). No prior knowledge of supply chain security standards is required.
